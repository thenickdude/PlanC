...
plan-c : $(SOURCE) $(SUBMODULES) $(STATIC_LIBS) boost/boost/
	$(CXX) $(STATIC_OPTIONS) -Wall --std=c++14 -O3 -g3 -o $@ -Iboost -Ileveldb/include -Icpp_properties/src/include -Icpp_properties/example/include -Izlib -Izstr/src $(SOURCE) $(STATIC_LIBS) -lpthread
